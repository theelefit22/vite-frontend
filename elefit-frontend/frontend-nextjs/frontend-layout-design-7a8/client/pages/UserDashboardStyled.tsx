          ...
          <section className="flex flex-col items-center gap-5 pt-6 pb-8">
            <div className="flex flex-col items-center gap-2">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="text-muted-foreground text-sm font-medium">{userData.email}</div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center gap-6 w-full">
              {statsData.map((stat, index) => (
                ...
                >
                  <div className="text-foreground text-lg font-medium">{stat.value}</div>
                  <div className="text-muted-foreground text-xs font-normal">{stat.label}</div>
                </div>
              ))}
            </div>
          </section>
          ...
          <nav className="flex border-b border-border px-8">
            ...
            >
              <div className="flex items-center justify-center gap-2">
                <User
                  className={`w-[18px] h-[18px] ${activeTab === 'profile' ? 'text-primary' : 'text-muted-foreground'}`}
                />
                <span
                  className={`text-xs font-semibold ${activeTab === 'profile' ? 'text-primary' : 'text-muted-foreground'}`}
                >
                  Profile Info
                </span>
              </div>
            ...
            >
              <div className="flex items-center justify-center gap-2">
                <Download
                  className={`w-[18px] h-[18px] ${activeTab === 'schedules' ? 'text-primary' : 'text-muted-foreground'}`}
                />
                <span
                  className={`text-xs font-semibold ${activeTab === 'schedules' ? 'text-primary' : 'text-muted-foreground'}`}
                >
                  Saved Schedules
                </span>
              </div>
