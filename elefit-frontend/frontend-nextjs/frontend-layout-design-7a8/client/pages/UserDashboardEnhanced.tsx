          ...
          <div className="flex flex-col items-center py-8 border-b border-gray-800">
            ...
            <div className="flex justify-center gap-6 mt-8">
              <div className="bg-gray-900 border border-gray-700 rounded-lg px-6 py-4 text-center min-w-[120px]">
                ...
                <div className="text-sm text-gray-400 mt-1">Height</div>
              </div>
              <div className="bg-gray-900 border border-gray-700 rounded-lg px-6 py-4 text-center min-w-[120px]">
                <div className="text-xl font-semibold text-white">{userData.weight || '73'} kg</div>
                <div className="text-sm text-gray-400 mt-1">Weight</div>
              </div>
              <div className="bg-gray-900 border border-gray-700 rounded-lg px-6 py-4 text-center min-w-[120px]">
                <div className="text-xl font-semibold text-white">{userData.age || '27'} y</div>
                <div className="text-sm text-gray-400 mt-1">Age</div>
              </div>
            </div>
          </div>
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    ...
                    {renderTextArea(
                      'Health Goals',
                      'healthGoals',
                      'Describe your health and fitness goals'
                    )}
                    {renderTextArea(
