...
export default function Welcome() {
  ...
  return (
    <div 
      ...
      style={{
        background: 'linear-gradient(0deg, rgba(23, 23, 23, 0.93) 0%, rgba(23, 23, 23, 0.93) 100%), url(https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=1920&h=1080&fit=crop) center/cover no-repeat'
      }}
    >
      {/* Glow Effect */}
