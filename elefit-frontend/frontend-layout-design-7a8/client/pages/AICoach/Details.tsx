            ...
            <div className="flex flex-col items-start gap-9 relative self-stretch w-full flex-[0_0_auto]">
              <div className="flex flex-col w-[332px] items-start gap-[9px] relative flex-[0_0_auto]">
                <div className="inline-flex items-center gap-[5px] relative flex-[0_0_auto]">
                  ...
                  <span
                    className="relative w-[31px] h-[31px] text-2xl flex items-center justify-center"
                    aria-hidden="true"
                  >
                    🔥
                  </span>
              ...
              <div className="flex flex-col items-start gap-3.5 relative self-stretch w-full flex-[0_0_auto]">
                <div className="flex flex-col items-start gap-[9px] relative self-stretch w-full flex-[0_0_auto]">
                  <label
                    htmlFor="name"
                    className="relative self-stretch mt-[-1.00px] [font-family:'Inter-Regular',Helvetica] font-normal text-[#fbffdb] text-sm tracking-[0] leading-[normal]"
                  >
                    Name
                  </label>
                  ...
                  <div className="flex flex-col items-start gap-[9px] relative flex-1 grow">
                    ...
                    <div className="flex h-12 items-center justify-center gap-2.5 px-4 py-[11px] relative self-stretch w-full rounded-lg overflow-hidden border border-solid border-[#454545] bg-[#212121] bg-opacity-90">
                      <input
                        ...
                        min="1"
                        max="120"
                        className="relative flex-1 [font-family:'Inter-Regular',Helvetica] font-normal text-[#595959] text-sm tracking-[0] leading-[normal] bg-transparent w-full focus:outline-none"
                        required
                        aria-required="true"
                      />
                    </div>
                ...
                <div className="flex flex-col items-start gap-[9px] relative self-stretch w-full flex-[0_0_auto]">
                  ...
                  <div className="flex items-start gap-[9px] relative self-stretch w-full flex-[0_0_auto]">
                    <div className="flex h-12 items-center justify-center gap-2.5 px-4 py-[11px] relative flex-1 grow rounded-lg overflow-hidden border border-solid border-[#454545] bg-[#212121] bg-opacity-90">
                      <input
                        type="number"
                        id="timeline"
                        name="timeline"
                    ...
                    >
                      <button
                        type="button"
                        className="flex w-[83px] h-12 items-center justify-center gap-2.5 px-4 py-[11px] relative rounded-[8px_0px_0px_8px] overflow-hidden bg-[#0088ff]"
                        aria-pressed="true"
                      >
                      ...
                      <button
                        type="button"
                        className="flex w-[83px] h-12 items-center justify-center gap-2.5 px-4 py-[11px] relative rounded-[0px_8px_8px_0px] overflow-hidden bg-[#212121]"
                        aria-pressed="false"
                      >
