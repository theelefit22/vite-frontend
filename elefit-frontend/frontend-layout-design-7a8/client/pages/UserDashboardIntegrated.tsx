...
const UserDashboardIntegrated = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-[#171717]">
      {/* Top Navigation Bar */}
      <header className="w-full h-[86px] flex items-center justify-between bg-[#111111] border-b border-[#212121] px-16">
            ...
            <div className="flex items-center justify-center gap-6 w-full">
              {statsData.map((stat, index) => (
                ...
                >
                  ...
                  <div className="text-[#ababab] text-xs font-normal">
                    {stat.label}
                  </div>
                </div>
              ))}
          ...
          <nav className="flex border-b border-[#212121] px-8">
            ...
            >
              <div className="flex items-center justify-center gap-2">
                <User className={`w-[18px] h-[18px] ${activeTab === 'profile' ? 'text-[#ccd853]' : 'text-[#999999]'}`} />
                <span className={`text-xs font-semibold ${activeTab === 'profile' ? 'text-[#ccd853]' : 'text-[#999999]'}`}>
                  Profile Info
                </span>
              </div>
            </button>
            ...
            >
              <div className="flex items-center justify-center gap-2">
                <Download className={`w-[18px] h-[18px] ${activeTab === 'schedules' ? 'text-[#ccd853]' : 'text-[#999999]'}`} />
                <span className={`text-xs font-semibold ${activeTab === 'schedules' ? 'text-[#ccd853]' : 'text-[#999999]'}`}>
                  Saved Schedules
                </span>
              </div>
            </button>
                        ...
                        {field.type === "select" ? (
                          <div className="relative">
                            <select
                              ...
                              className="w-full h-[39px] bg-[#212121] rounded-lg border border-[#454545] px-3 text-white text-sm font-normal appearance-none"
                            >
                          ...
                          <input
                            ...
                            value={userData[field.name]}
                            onChange={(e) => handleInputChange(field.name, e.target.value)}
                            className="w-full h-[39px] bg-[#212121] rounded-lg border border-[#454545] px-3 text-white text-sm font-normal"
                          />
                        )}
                      </div>
                    ))}
                    ...
                    {textareaFields.map((field) => (
                      <div key={field.name} className="space-y-2">
                        ...
                        <textarea
                          value={userData[field.name]}
                          onChange={(e) => handleInputChange(field.name, e.target.value)}
                          className="h-[123px] w-full bg-[#212121] rounded-lg border border-[#454545] p-3 text-white text-sm font-normal resize-none"
                        />
                      </div>
                    ))}
                  </div>
...
export default UserDashboardIntegrated;