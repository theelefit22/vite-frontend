              ...
              <div className="flex justify-center items-center gap-6 w-full">
                <div className="flex py-3.5 px-4 flex-col justify-center items-center gap-2.5 rounded-lg border border-[#212121] bg-[#0D0D0D] w-full h-full overflow-hidden">
                  <div className="flex flex-col items-center gap-2 w-full">
                    ...
                    <p className="text-[#ACACAC] font-inter text-xs w-full text-center">
                      Height
                    </p>
                  </div>
                </div>
            ...
            <div className="flex items-center w-[768px] absolute left-[254px] top-[318px]">
              ...
              >
                <div className="flex py-[5px] px-2.5 items-start gap-1.5 w-fit">
                  ...
                  <p className={`font-inter text-xs font-semibold w-fit ${activeTab === 'profile' ? 'text-[#CCD853]' : 'text-[#999]'}`}>
                    Profile Info
                  </p>
                </div>
              </div>
              ...
              >
                <div className="flex py-[5px] px-2.5 items-start gap-1.5 w-fit">
                  ...
                  <p className={`font-inter text-xs font-semibold w-fit ${activeTab === 'schedules' ? 'text-[#CCD853]' : 'text-[#999]'}`}>
                    Saved Schedules
                  </p>
                </div>
              </div>
